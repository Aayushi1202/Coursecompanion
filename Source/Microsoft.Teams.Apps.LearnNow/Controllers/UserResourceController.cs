// <copyright file="UserResourceController.cs" company="Microsoft">
    ...
    public class UserResourceController : BaseController
    {
        ...
        public async Task<IActionResult> SearchAsync(int page, UserLearningFilterModel filterModel)
        {
            ...
            try
            {
                ...
                var userAADObjectIds = resources.Select(resource => resource.UpdatedBy).Distinct().Select(userObjectId => userObjectId.ToString());
