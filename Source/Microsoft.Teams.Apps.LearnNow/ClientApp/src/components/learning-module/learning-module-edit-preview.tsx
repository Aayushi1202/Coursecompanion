                            ...
                            <div className="tab-footer-preview">
                                <div>
                                    <Flex space="between">
                                        ...
                                        <Flex.Item>
                                            <Button className="next-button-preview" content={this.localize("shareButtonText")} primary onClick={this.handleSaveButtonClick} loading={this.state.isSaveButtonLoading} disabled={this.state.isSaveButtonDisabled}/>
                                        </Flex.Item>
                                    </Flex>
                                </div>
                            </div>
