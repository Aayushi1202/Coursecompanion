...
class SelectImagePage extends React.Component<ISelectImagePageProps, IPreviewImageState> {
   ...
   */
    ...
    */
    private showContent = () => {
        console.log("image" + this.props.windowWidth)
                    ...
                    <div>
                        <Flex space="between">
                            ...
                            <Flex gap="gap.small" className="next-button">
                                <Button content={this.localize("previewButtonText")} primary onClick={this.props.handleImageNextButtonClick} disabled={this.props.isImageNextBtnDisabled} />
                            </Flex>
                        </Flex>
                    </div>
                </div>
