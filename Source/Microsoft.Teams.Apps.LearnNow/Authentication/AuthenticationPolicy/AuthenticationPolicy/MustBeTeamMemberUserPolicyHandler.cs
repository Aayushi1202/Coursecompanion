    ...
    public class MustBeTeamMemberUserPolicyHandler : IAuthorizationHandler
    {
        ...
        private async Task<bool> ValidateUserIsPartOfTeamAsync(string teamId, string userAadObjectId, string accessToken)
        {
            ...
            if (!isCacheEntryExists)
            {
                ...
                var isValidTeamMember = await this.memberValidationService.ValidateMemberAsync(userAadObjectId, teamId, accessToken);
                this.memoryCache.Set(this.GetCacheKey(teamId, userAadObjectId), isValidTeamMember, cacheDurationInMinutes);
            }
