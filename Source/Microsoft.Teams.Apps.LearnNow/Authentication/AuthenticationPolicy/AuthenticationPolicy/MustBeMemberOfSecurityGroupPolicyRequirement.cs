// <copyright file="MustBeMemberOfSecurityGroupPolicyRequirement.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.LearnNow.Authentication.AuthenticationPolicy.AuthenticationPolicy
{
    ...
    /// </summary>
    public class MustBeMemberOfSecurityGroupPolicyRequirement : IAuthorizationRequirement
    {
    }
}
